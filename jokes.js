let output = document.querySelector(".joke-box");
let btn = document.querySelector("#newJoke");

let sampleArr =['joke1','joke2','joke3','joke4','joke5'];

let jokesarr= [`What do you call a boomerang that won\t come back? 
A stick. `,
...
Food was good, but there really wasn\t much atmosphere. `,
 
` Why did the dinosaur cross the road? 
Because the chicken wasn\t born yet. `,
 
` Why can\t Elsa from Frozen have a balloon? 
...
Don\t take me for granite. `,
 
` Why does a seagull fly over the sea? 
Because if it flew over the bay, it would be a baygull. `,
 
` What kind of water can\t freeze? 
Hot water. `,
...
Because he wasn\t greater than or less than anyone else. `,
...
` Why don\t pirates shower before they walk the plank? 
...
function getJokes() {
    let arrIndex=Math.floor( Math.random()*jokesarr.length);
    return jokesarr[arrIndex];
}

function displayJokes(){
    output.innerHTML=`"${getJokes()}"`;
}
